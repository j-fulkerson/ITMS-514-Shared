...
answer_dist <- print(paste("The average of dist with a speed greater than ", speed_average, " is ", new_dist_average, " and the standardd deviation is ", new_standard_dev_dist ))
```
